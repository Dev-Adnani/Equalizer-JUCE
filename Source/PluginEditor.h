...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<EqualizerJUCEAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<EqualizerJUCEAudioProcessor::BlockType>* leftChannelFifo;
...
private:
    ...
    juce::Rectangle<int> getAnalyisArea();
...
public:
    ...
    ~EqualizerJUCEAudioProcessorEditor() override;
